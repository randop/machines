...
pdns_server --version
# Aug 29 06:01:02 Loading '/usr/lib/powerdns/libremotebackend.so'
# Aug 29 06:01:02 Loading '/usr/lib/powerdns/libpipebackend.so'
# Aug 29 06:01:02 Loading '/usr/lib/powerdns/libldapbackend.so'
# Aug 29 06:01:02 Loading '/usr/lib/powerdns/libgpgsqlbackend.so'
# Aug 29 06:01:02 Loading '/usr/lib/powerdns/liblmdbbackend.so'
# Aug 29 06:01:02 Loading '/usr/lib/powerdns/libgeoipbackend.so'
# Aug 29 06:01:02 Unable to load module '/usr/lib/powerdns/libgeoipbackend.so': libyaml-cpp.so.0.9: cannot open shared object file: No such file or directory
# Aug 29 06:01:02 DNSBackend unable to load module in libgeoipbackend.so
# PowerDNS Authoritative Server 5.1.4 (C) PowerDNS.COM BV
# Using 64-bits mode. Built using gcc 16.2.1 20260810.
...
kea-dhcp4 -V
# 3.2.0-git (git e1855213f333e96f65b952676cc03f93942b1e57)
# premium: no
# linked with:
# - log4cplus 2.2.0
...
# Optional features available: CPU affinity setting, IPv6 flow label, SCTP, TCP congestion algorithm setting, sendfile / zerocopy, socket pacing, authentication, bind to device, support IPv4 don't fragment, POSIX threads, GSO/GRO support
...
# Licenses        : BSD-2-Clause  CC-BY-SA-3.0  CC-BY-SA-4.0  GPL-2.0-only  GPL-2.0-or-later  GPL-3.0-or-later  LGPL-2.1-or-later
...
# Conflicts With  : None
# Replaces        : None
# Installed Size  : 1930.69 KiB
# Packager        : Campbell Jones <serebit@archlinux.org>
# Build Date      : Wed 29 Apr 2026 04:14:23 AM UTC
# Install Date    : Sat 29 Aug 2026 05:47:44 AM UTC
...
sqlite3 --version
# 3.53.4 2026-07-24 19:02:57 bf7c7f30031888f4e796e429ab3978879485813aaca6f641c7b33e4e0945alt1 (64-bit)
...
# Installed Size  : 31.45 MiB
# Packager        : T.J. Townsend <blakkheim@archlinux.org>
# Build Date      : Wed 12 Aug 2026 10:04:42 PM UTC
# Install Date    : Sat 29 Aug 2026 05:47:35 AM UTC
# Install Reason  : Explicitly installed
# Install Script  : No
# Validated By    : Signature
